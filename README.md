...
Ссылка: https://bakery-web-my-repo.onrender.com/ (возможно придется подождать, чтобы сервер очнулся)
## Основные возможности

- 🧁 Просмотр каталога тортов, пирожных, фотографий с пагинацией;
- 🥨 Интерфейс для поиска тортов по названию;
- 🍰 Интерфейс для  создания, редактирование и удаление товаров
- 🍪 Недоступность каталога для редактирования без авторизации
- 🎂 Конструктор для выбора десертов на компанию
